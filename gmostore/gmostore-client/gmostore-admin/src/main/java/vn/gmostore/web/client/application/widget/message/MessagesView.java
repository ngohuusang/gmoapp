...
import vn.gmostore.web.client.application.widget.message.ui.MessageWidget;
import vn.gmostore.web.client.application.widget.message.ui.MessageWidgetFactory;
