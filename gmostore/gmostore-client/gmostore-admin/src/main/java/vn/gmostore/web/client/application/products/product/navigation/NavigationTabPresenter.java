...
public class NavigationTabPresenter extends PresenterWidget<NavigationTabPresenter.MyView> implements NavigationTabEvent.NavigationTabHandler,
    ...
    @Inject
    NavigationTabPresenter(EventBus eventBus, MyView view, PlaceManager placeManager) {
        super(eventBus, view);
